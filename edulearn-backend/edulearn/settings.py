...
VULNERABLE CONFIGURATION - FOR TRAINING ONLY
File: backend/edulearn/settings.py
"""
...
SECRET_KEY = 'django-insecure-hardcoded-secret-key-DO-NOT-USE-12345'
DEBUG = True  # Never enable in production
ALLOWED_HOSTS = ['*']  # Dangerous - allows all hosts
